...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    \frac{1}{x}
  \end{IEEEeqnarray}
  However this alone cannot be the solutions as it is the characteristic function in
  $\lambda$ of a purely deterministic $Y_t$. Until more constraints can be found the
  following proposition remains open.
  \begin{proposition}[Gompertz Hazard]
    The analytic function $f_{\mu, \sigma}$ is simply the exponential divide by its
    ...
    \end{IEEEeqnarray}
  \end{proposition}
  In most circumstances $\lambda$ is new born infant mortality due to ageing alone and is
  less than one in ten thousand person years. As such the hazard is very close to the
