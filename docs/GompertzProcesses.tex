...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    \operatorname{\mathbb{P}}\left[T_n =t \right\rVert\left. Y_t \right]
    & = & 
    \frac{\left(\mu+\sigma^2/2\right)e^{\left(\mu+\sigma^2/2\right)t}}{e^{\left(\mu+\sigma^2/2\right)t}-1} \frac{\left(\lambda Y_t\right)^n}{\left(n-1\right)!} e^{-\lambda Y_t}
  \end{IEEEeqnarray}
