...
\begin{document}
  ...
  \end{IEEEeqnarray}
  For the stopping time $T_n$ of the passage of the Gompertz process $G_{T_n} = n$ we have
  the conditional expectation:
  \begin{IEEEeqnarray}{rCl}
    \operatorname{\mathbb{P}}\left[ T_n \right\rVert\left. Y_{T_n} \right]
    & = &
    ...
    e^{-\lambda Y_t}
  \end{IEEEeqnarray}
  In practice we cannot measure the accelerated metabolic time $Y_t$ instead we have access
  to the stopping times $T_n, \dots , T_0$.
