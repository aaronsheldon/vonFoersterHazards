...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    \operatorname{\mathbb{E}}\left[\lambda X_v e^{-\lambda Y_v}\right]
    dv du\nonumber\\
    &   &
  ...
  organism introduces a correlation between the latencies of consecutive events, and that
  this correlation can be fully accounted for by conditioning on the age of the organism at
  the sentinel event. 
