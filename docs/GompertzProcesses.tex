...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    \underset{\frac{t}{n} \sum\prod u_i = Y_t}{\int \cdots \int}
    \operatorname{\mathbb{P}}\left[ X_\frac{t}{n} = u_1 \right] \cdots\nonumber\\
    &   &
    \qquad\qquad\qquad\qquad \cdots
    \operatorname{\mathbb{P}}\left[ X_\frac{t}{n} = u_n \right]
    du_1 \cdots du_n
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    \left\lbrace
      \frac{1}{n-1}
      \sum_{m=0}^{n-2} X_{\frac{n}{m}t} \vee X_{\frac{n+1}{m}t}
      > \left(\frac{n-1}{n}\frac{y}{t} - x\right) \vee 0
    \right\rbrace
  \end{IEEEeqnarray}
  ...
  Gompertz process $G_t$. As before, we condition the the stopping time on the history of
  stochastic accelerations to recover the familiar forms of the Poisson process, by
  differentiating the subordinated cumulative distribution of a single stopping time:
  \begin{IEEEeqnarray}{rCl}
