...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    \frac{\operatorname{\mathbb{E}}\left[ X_t \right]}
    {\operatorname{\mathbb{E}}\left[ Y_t \right]}
    \frac{\partial p}{\partial t}
  ...
  \begin{IEEEeqnarray}{rCl}
    p
    & = &
    e^{\frac{1}{\mu + \frac{\sigma^2}{2}}\left(t - \frac{\operatorname{\mathbb{E}}\left[ Y_t \right]}{\operatorname{\mathbb{E}}\left[ E_t \right]}\right)}
    g_{\mu, \sigma}\left(y + \frac{1}{\mu + \frac{\sigma^2}{2}}\left(t - \frac{\operatorname{\mathbb{E}}\left[ Y_t \right]}{\operatorname{\mathbb{E}}\left[ E_t \right]}\right) \right)
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    \operatorname{\mathbb{E}}\left[Y_t\right]
    f_{\mu, \sigma}\left( \lambda \operatorname{\mathbb{E}}\left[Y_t\right] \right)
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{rCl}
    \IEEEeqnarraymulticol{3}{l}
    {
      \displaystyle-\frac{\partial}{\partial t} \ln\int_{\frac{1}{\mu + \frac{\sigma^2}{2}}\left(t - \frac{\operatorname{\mathbb{E}}\left[ Y_t \right]}{\operatorname{\mathbb{E}}\left[ E_t \right]}\right)}^\infty
      e^{\lambda u}
    ...
    \displaystyle
    \left(1 - \lambda\right)
    \frac{\operatorname{\mathbb{E}}\left[ Y_t \right]}{\operatorname{\mathbb{E}}\left[ E_t \right]}
    + \lambda^2
    \operatorname{\mathbb{E}}\left[X_t\right]
    \operatorname{\mathbb{E}}\left[Y_t\right]
    f_{\mu, \sigma}\left( \lambda \operatorname{\mathbb{E}}\left[Y_t\right] \right)
  ...
  \begin{proposition}[Gompertz Anomaly]
    ...
    \begin{IEEEeqnarray}{rCl}
      ...
      e^{\frac{\sigma^2}{2}\lambda \operatorname{\mathbb{E}}\left[Y_t\right]}
    \end{IEEEeqnarray}
  \end{proposition}
