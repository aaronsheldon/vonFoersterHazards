...
\begin{document}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    & = &
    \operatorname{\mathbb{E}}\left[ Y_t \right]
    g_{\mu, \sigma}\left(y \operatorname{\mathbb{E}}\left[ Y_t \right]\right)
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    f_{\mu, \sigma}\left( \lambda \operatorname{\mathbb{E}}\left[Y_t\right] \right)
  \end{IEEEeqnarray} 
  Until more constraints can be found we only have dimensional analysis to inform our choice
  in solution leaving the following proposition open.
  ...
  original hazard observed by Gompertz. Intuitively, when $\mu \ggg \sigma^2 / 2$ the
