...
\begin{document}
  ...
  theory of ageing must be one the studies the subordination of the failure time by an 
  ...
  If we assume as a first approximation that the stresses, and their respective
  accelerations, are independent and stationary over time then by the L\'evy-Khintchine
  characterization integrated Brownian motion is the only representation of elapsed
  metabolic time that is L\'evy and continuous, \emph{jump free}.
  ...
  $X_t$ of accumulated accelerations up to time $t$ and whose integral $Y_t$ is a strictly
  increasing stochastic process of elapsed metabolic time up to time $t$.

  To start our exploration of the rich and subtletie of Gompertz processes we will briefly
  ...
  material I will cover has been explored deeply and thoroughly in the quantitative finance
  literature within the context of pricing Asian options.
  ...
  \begin{IEEEeqnarray}{rCl}
    ...
    & = &
    e^{\left(\mu + \frac{\sigma^2}{2}\right)t}\\
    \operatorname{\mathbb{E}}\left[ Y_t \right]
    & = &
    \frac{e^{\left(\mu + \frac{\sigma^2}{2}\right)t} - 1}{\mu + \frac{\sigma^2}{2}}
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{rCl}
    h & = & \lambda^2 \operatorname{\mathbb{E}}\left[X_t\right] \operatorname{\mathbb{E}}\left[Y_t\right] f_{\mu, \sigma}\left( \lambda \operatorname{\mathbb{E}}\left[Y_t\right] \right)
  \end{IEEEeqnarray}
