...
\begin{document}
  ...
  stochastically accelerated metabolic time:
  \begin{IEEEeqnarray}{rCl}
    \operatorname{d\mathbb{P}}\left[ Y_{T_n} \right\rVert\left. T_n = t \right]
    & = &
    ...
    \operatorname{d\mathbb{P}}\left[ Y_t \right]\\\nonumber\\
    \operatorname{d\mathbb{P}}\left[ X_{T_n} \right\rVert\left. T_n = t \right]
    & = &
    \frac{\operatorname{\mathbb{E}}\left[ X_t Y_t^{n-1} e^{-\lambda Y_t} \right\rVert\left. X_t \right]}
    {\operatorname{\mathbb{E}}\left[ X_t Y_t^{n-1} e^{-\lambda Y_t} \right]}
    \operatorname{d\mathbb{P}}\left[ X_t \right]
  \end{IEEEeqnarray}
