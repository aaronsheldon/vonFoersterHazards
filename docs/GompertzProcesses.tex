...
\begin{document}
  ...
  approximation that the stresses, and their respective accelerations, are independent and
  stationary over time then by the L\'evy-Khintchine characterization Brownian motion is the
  only infinitesimal generator $B_u$ of elapsed metabolic time that is L\'evy and
  continuous, \emph{jump free}. The stochastic process of elapsed metabolic is better know
  as integrated Brownian motion.
